#!/usr/bin/env python3
"""Markdown论文 → DOCX转换器（读取paper/技术论文_v0.2.md）"""
import sys, os, re

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
md_path = os.path.join(os.path.dirname(__file__), '技术论文_v0.2.md')
...
# Save
out_path = os.path.join(os.path.dirname(__file__), 'YLYW技术论文_v0.2.docx')
doc.save(out_path)
