#!/usr/bin/env python3
"""将 ch01_1_2.md 转换为 docx —— 彻底清理所有 markdown 语法"""
...
with open('/home/lijinhan/MXL/科研/ylyw/monograph/ch01_1_2.md', 'r') as f:
    content = f.read()

process_md(content)

output_path = '/home/lijinhan/MXL/科研/ylyw/monograph/第1章_1.2_从符号先验到通用智能.docx'
