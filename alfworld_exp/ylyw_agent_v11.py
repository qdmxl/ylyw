#!/usr/bin/env python3
"""
YLYW Agent V11 — V10 + 场景记忆 + 知几V11升级

相比V10的改进：
1. 场景记忆(Scene Memory) — 跨局记住每个FloorPlan的物体-位置关联
2. 知几V11 — 六爻模板学习 + 行为模式学习 + 置信度衰减
3. 知耻+爻调保持不变
"""
...
class YLYWAgentV11:
    ...
    相比V10的新增：
    6. 场景记忆 — 跨局记住每个FloorPlan的物体位置，同一场景下次再去就知道东西在哪
    7. 知几V11 — 六爻模板学习 + 行为模式学习 + 置信度衰减
    """
