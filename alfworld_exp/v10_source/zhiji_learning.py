...
class ZhijiLearning:
    ...
    def save_experience(self, path: str):
        ...
        data = {
            ...
            'object_location_counts': {k: dict(v) for k, v in self.object_location_counts.items()},
    ...
    def load_experience(self, path: str):
        ...
        for k, v in data.get('object_location_counts', {}).items():
            for loc, cnt in v.items():
                self.object_location_counts[k][loc] += cnt
